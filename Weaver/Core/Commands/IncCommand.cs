...
{
    /// <summary>
    /// Increments a numeric value in the registry.
    /// </summary>
    public sealed class IncCommand : ICommand
    {
        /// <summary>
        /// The registry
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IncCommand"/> class.
        /// </summary>
        /// <param name="registry">The registry.</param>
        public IncCommand(IVariableRegistry registry)
        {
            _registry = registry;
        }
        ...
        /// <inheritdoc />
        public string Description => "Increments a numeric variable by 1. Usage: Inc([key])";
        ...
        public CommandResult Execute(params string[] args)
        {
            ...
            try
            {
                switch (type)
                {
                    ...
                    case EnumTypes.Wdouble:
                        ...
                        break;
                    default:
                        return CommandResult.Fail($"Inc only supports numeric types. Current type: {type}");
                }
            ...
            {
                return CommandResult.Fail($"Failed to increment '{key}': {ex.Message}");
            }
        }
    }
}
