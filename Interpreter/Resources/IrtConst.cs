    ...
    {
        {
            ...
            new InCommand
            {
                Command = InternalCommandHelp, Description = "Help : List all external Commands.", ParameterCount = 0
            }
        },
        {
        ...
        },
        {
            ...
            new InCommand
            {
                Command = InternalErrorLog, Description = "Log : Enumerate all Error Log entries.", ParameterCount = 0
            }
        },
        {
            7,
