...
namespace CoreBuilder
{
    ...
    public sealed class ResXtract : IResourceExtractor
    {
        ...
        private bool ShouldIgnoreFile(string filePath)
        {
            ...
            // Ignore generated files (e.g., *.g.cs, *.designer.cs, AssemblyAttributes.cs)
            ...
            // Detect <auto-generated> comment at the top of the file
            try
            {
            ...
            {
                // If there's an IO issue, just skip the file to be safe
                return true;
            }
